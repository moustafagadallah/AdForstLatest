...
class LoginViewController: UIViewController, UITextFieldDelegate, NVActivityIndicatorViewable,  GIDSignInDelegate, UIScrollViewDelegate,ASAuthorizationControllerDelegate, ASAuthorizationControllerPresentationContextProviding{
    ...
    @IBOutlet weak var loginWithAppleStack: UIStackView!
...
//    }
    ...
    override func viewDidLoad() {
        ...
        if #available(iOS 13.0, *){
            ...
            loginWithAppleStack.addArrangedSubview(getAppleSignInButton())
               }
