...
class RegisterViewController: UIViewController,UITextFieldDelegate, UIScrollViewDelegate, NVActivityIndicatorViewable, GIDSignInDelegate, ASAuthorizationControllerDelegate, ASAuthorizationControllerPresentationContextProviding{
...
//
    ...
    override func viewDidLoad() {
        ...
        if #available(iOS 13.0, *){
          //  getAppleSignInButton().frame = loginWithAppleView.frame
            
          //  loginWithAppleView.addSubview(getAppleSignInButton())
            signWithAppleStack.addArrangedSubview(getAppleSignInButton())
        }
